...
test('home to blog to toronto zoo post flow', async ({ page }) => {
  ...
  await page.getByRole('link', { name: /Toronto Zoo Field Notes \(February 28, 2026\)/i }).click();
  ...
  await page.getByRole('link', { name: /Toronto Zoo Field Notes \(March 1, 2026\)/i }).click();
